...
Ron Ross Kevin Dulany Peter Duspiva Kelley Dempsey *NIST, JTF Leader DoD Intelligence Community NIST*

Taylor Roberts Ellen Nadeau Victoria Pillitteri Naomi Lefkovitz *OMB NIST NIST NIST* Jordan Burris Charles Cutshall Kevin Herms Carol Bales *OMB OMB OMB OMB* Jeff Marron Kaitlin Boeckl Kirsten Moncada Jon Boyens *NIST NIST OMB NIST* Dorian Pappas Dominic Cussatt Esten Porter Celia Paulsen *CNSS Veterans Affairs The MITRE Corporation NIST* Daniel Faigin Christina Sames Julie Snyder Martin Stanley *The Aerospace Corporation The MITRE Corporation The MITRE Corporation Homeland Security*
...
<sup>1</sup> An *information system* is a discrete set of information resources organized for the collection, processing, maintenance, use, sharing, dissemination, or disposition of information [44 USC 3502]. The term information system includes, for example, general-purpose computing systems; industrial/process control systems; cyber-physical systems; weapons systems; super computers; command, control, and communications systems; devices such as smart phones and tablets; environmental control systems; embedded devices/sensors; and paper-based systems.

<sup>2</sup> Defense Science Board Task Force Report, *Resilient Military Systems and the Advanced Cyber Threat* [DSB 2013].

<sup>3</sup> Organizational operations include mission, functions, image, and reputation.

<sup>4</sup> Adverse impacts include, for example, compromises to systems supporting critical infrastructure applications or that are paramount to government continuity of operations as defined by the Department of Homeland Security.

<sup>5</sup> Risk is a measure of the extent to which an entity is threatened by a potential circumstance or event. Risk is also a function of the adverse impacts that arise if the circumstance or event occurs, and the likelihood of occurrence. Types of risk include program risk; compliance/regulatory risk; financial risk; legal risk; mission/business risk; political risk; security and privacy risk (including supply chain risk); project risk; reputational risk; safety risk; strategic planning risk.

<sup>6 [</sup>OMB A-130] defines PII as "information that can be used to distinguish or trace an individual's identity, either alone or when combined with other information that is linked or linkable to a specific individual."
...
<sup>8</sup> SCRM requirements are promulgated in [OMB A-130], [DODI 5200.44], and for national security systems in [CNSSD 505]. SCRM requirements have also been addressed by the Federal SCRM Policy Coordinating Committee.

<sup>10 [</sup>SP 800-64] and [SP 800-160 v1] provide guidance on security considerations in the SDLC.
...
<sup>12</sup> Section 2.6 describes the relationship between requirements and controls with respect to RMF execution.

<sup>13 [</sup>OMB FEA] provides guidance on the Federal Enterprise Architecture.

<sup>14 [</sup>OMB M-17-25] provides guidance on risk management roles and responsibilities.

<sup>15</sup> IT resources refer to the information technology component of *information resources* defined in [OMB A-130].

<sup>16 [</sup>SP 800-137] provides guidance on information security continuous monitoring supporting ongoing authorization. Future publications will address privacy continuous monitoring.
...
<sup>17 [</sup>SP 800-160 v1] provides guidance on systems security engineering and building trustworthy, secure systems.

<sup>18 [</sup>EO 13800] directs federal agencies to use the [NIST CSF] to manage cybersecurity risk.

<sup>19</sup> The term organization is used in this publication to describe an entity of any size, complexity, or positioning within an organizational structure (e.g., a federal agency or, as appropriate, any of its operational elements).
...
his chapter describes the basic concepts associated with managing information systemrelated security and privacy risk in organizations. These concepts include the RMF steps and task structure; information security and privacy programs in the RMF; information system, system elements, and how authorization boundaries are established; security and privacy posture; and security and privacy risk management practices associated with the supply chain. T
...
| Tasks | Outcomes |
| --- | --- |
| TASK P-1 • | Individuals are identified and assigned key roles for |
| RISK MANAGEMENT ROLES | executing the Risk Management Framework. |
|  | [Cybersecurity Framework: ID.AM-6; ID.GV-2] |
| TASK P-2 • | A risk management strategy for the organization that |
| RISK MANAGEMENT STRATEGY | includes a determination and expression of organizational |
|  | risk tolerance is established. |
|  | [Cybersecurity Framework: ID.RM; ID.SC] |
| • TASK P-3 | An organization-wide risk assessment is completed or an |
| RISK ASSESSMENT—ORGANIZATION | existing risk assessment is updated. |
|  | [Cybersecurity Framework: ID.RA; ID.SC-2] |
| TASK P-4 • | Organizationally-tailored control baselines and/or |
| ORGANIZATIONALLY-TAILORED CONTROL | Cybersecurity Framework Profiles are established and |
| BASELINES AND CYBERSECURITY | made available. |
| FRAMEWORK PROFILES (OPTIONAL) | [Cybersecurity Framework: Profile] |
| • TASK P-5 | Common controls that are available for inheritance by |
| COMMON CONTROL IDENTIFICATION | organizational systems are identified, documented, and |
|  | published. |
| • TASK P-6 | A prioritization of organizational systems with the same |
| IMPACT-LEVEL PRIORITIZATION | impact level is conducted. |
| (OPTIONAL) | [Cybersecurity Framework: ID.AM-5] |
| • TASK P-7 | An organization-wide strategy for monitoring control |
| CONTINUOUS MONITORING STRATEGY— | effectiveness is developed and implemented. |
| ORGANIZATION | [Cybersecurity Framework: DE.CM; ID.SC-4] |
...
**Task Abbreviation Prepare Step Task 3**
...
38 The terms *system*, *system element*, *enabling system*, *other systems*, and the *environment of operation* are agnostic with respect to information technology (IT) and operations technology (OT).

<sup>39 <</sup>i>Common controls are referenced in the security and privacy plans for the system inheriting the controls.
...
<sup>41</sup> Information systems are discrete sets of information resources organized for the collection, processing, use, sharing, maintenance, dissemination, or disposition of information, whether such information is in digital or nondigital form. Information resources include information and related resources, such as personnel, equipment, funds, and information technology. Information systems may or may not include hardware, firmware, and software.
...
individuals, other organizations, or the Nation are acceptable based on the organization's risk management strategy and organizational risk tolerance.45
...
| Tasks | Outcomes |
| --- | --- |
| • TASK P-1 | Individuals are identified and assigned key roles for executing the |
| RISK MANAGEMENT ROLES | Risk Management Framework. |
|  | [Cybersecurity Framework: ID.AM-6; ID.GV-2] |
| • TASK P-2 | A risk management strategy for the organization that includes a |
| RISK MANAGEMENT STRATEGY | determination and expression of organizational risk tolerance is |
|  | established. |
|  | [Cybersecurity Framework: ID.RM; ID.SC] |
| TASK P-3 • | An organization-wide risk assessment is completed or an existing |
| RISK ASSESSMENT—ORGANIZATION | risk assessment is updated. |
|  | [Cybersecurity Framework: ID.RA; ID.SC-2] |
| • TASK P-4 | Organizationally-tailored control baselines and/or Cybersecurity |
| ORGANIZATIONALLY-TAILORED CONTROL | Framework Profiles are established and made available. |
| BASELINES AND CYBERSECURITY FRAMEWORK | [Cybersecurity Framework: Profile] |
| PROFILES (OPTIONAL) |  |
| TASK P-5 • | Common controls that are available for inheritance by |
| COMMON CONTROL IDENTIFICATION | organizational systems are identified, documented, and published. |
| • TASK P-6 | A prioritization of organizational systems with the same impact |
| IMPACT-LEVEL PRIORITIZATION (OPTIONAL) | level is conducted. |
...
<sup>53</sup> For ease of use, the preparatory activities are grouped into organization-level preparation and information systemlevel preparation.
...
**Discussion:** Risk tolerance is the degree of risk or uncertainty that is acceptable to an organization. Risk tolerance affects all parts of the organization's risk management process, having a direct impact on the risk management decisions made by senior leaders or executives throughout the organization and providing important constraints on those decisions. The risk management strategy guides and informs risk-based decisions including how security and privacy risk is framed, assessed, responded to, and monitored. The risk management strategy may be composed of a single document, or separate security and privacy risk management documents.54 The risk management strategy makes explicit the threats, assumptions, constraints, priorities, trade-offs, and risk tolerance used for making investment and
...
**Discussion:** Risk assessment at the organizational level leverages aggregated information from systemlevel risk assessment results, continuous monitoring, and any strategic risk considerations relevant to the organization. The organization considers the totality of risk from the operation and use of its information systems, from information exchange and connections with other internally and externally owned systems, and from the use of external providers. For example, the organization may review the risk related to its enterprise architecture and information systems of varying impact levels residing on the same network and whether higher impact systems are segregated from lower impact systems or systems operated and maintained by external providers. The organization may also consider the variability of environments that may exist within the organization (e.g., different locations serving different missions/business processes) and the need to account for such variability in risk assessments. Risk assessments of the organization's supply chain may be conducted as well. Risk assessment results may be used to help organizations establish a Cybersecurity Framework Profile.
...
| Tasks | Outcomes |
| --- | --- |
| • TASK P-8 | Missions, business functions, and mission/business processes that |
| MISSION OR BUSINESS FOCUS | the system is intended to support are identified. |
|  | [Cybersecurity Framework: Profile; Implementation Tiers; ID.BE] |
| TASK P-9 • | The stakeholders having an interest in the system are identified. |
| SYSTEM STAKEHOLDERS | [Cybersecurity Framework: ID.AM; ID.BE] |
| TASK P-10 • | Stakeholder assets are identified and prioritized. |
| ASSET IDENTIFICATION | [Cybersecurity Framework: ID.AM] |
| • TASK P-11 | The authorization boundary (i.e., system) is determined. |
| AUTHORIZATION BOUNDARY |  |
| TASK P-12 • | The types of information processed, stored, and transmitted by |
| INFORMATION TYPES | the system are identified. |
|  | [Cybersecurity Framework: ID.AM-5] |
| TASK P-13 • | All stages of the information life cycle are identified and |
| INFORMATION LIFE CYCLE | understood for each information type processed, stored, or |
|  | transmitted by the system. |
|  | [Cybersecurity Framework: ID.AM-3; ID.AM-4] |
| TASK P-14 • | A system-level risk assessment is completed or an existing risk |
| RISK ASSESSMENT—SYSTEM | assessment is updated. |
|  | [Cybersecurity Framework: ID.RA; ID.SC-2] |
| TASK P-15 • | Security and privacy requirements are defined and prioritized. |
| REQUIREMENTS DEFINITION | [Cybersecurity Framework: ID.GV; PR.IP] |
| TASK P-16 • | The placement of the system within the enterprise architecture is |
| ENTERPRISE ARCHITECTURE | determined. |
| • TASK P-17 | Security and privacy requirements are allocated to the system and |
| REQUIREMENTS ALLOCATION | to the environment in which the system operates. |
|  | [Cybersecurity Framework: ID.GV] |
| • TASK P-18 | The system is registered for purposes of management, |
| SYSTEM REGISTRATION | accountability, coordination, and oversight. |
|  | [Cybersecurity Framework: ID.GV] |
...
Organizations can use the Cybersecurity Framework to manage security and privacy requirements and express those requirements in Cybersecurity Framework *Profile*s defined for the organization. For instance, multiple requirements can be aligned and even deconflicted using the *Function-Category-Subcategory* structure of the Framework Core. The Profiles can then be used to inform the development of organizationally-tailored control baselines described in the RMF *Prepare-Organization Level* step, Task P-4.
...
| Tasks | Outcomes |
| --- | --- |
| TASK C-1 • | The characteristics of the system are described and documented. |
| SYSTEM DESCRIPTION | [Cybersecurity Framework: Profile] |
| • TASK C-2 | A security categorization of the system, including the information |
| SECURITY CATEGORIZATION | processed by the system represented by the organization |
...
|  | management strategy. |
| TASK C-3 • | The security categorization results are reviewed and the |
| SECURITY CATEGORIZATION REVIEW AND | categorization decision is approved by senior leaders in the |
...
<sup>74</sup> The RMF *Categorize* step is a precondition for the selection of security controls. However, for privacy, there are other factors considered by organizations that guide and inform the selection of privacy controls. These factors are described in the RMF *Prepare-System Level* step, Task P-15.
...
| Tasks | Outcomes |
| --- | --- |
| TASK S-1 • | Control baselines necessary to protect the system commensurate |
| CONTROL SELECTION | with risk are selected. |
|  | [Cybersecurity Framework: Profile] |
| • TASK S-2 | Controls are tailored producing tailored control baselines. |
| CONTROL TAILORING | [Cybersecurity Framework: Profile] |
| TASK S-3 • | Controls are designated as system-specific, hybrid, or common |
| CONTROL ALLOCATION | controls. |
...
| TASK S-4 • | Controls and associated tailoring actions are documented in |
| DOCUMENTATION OF PLANNED CONTROL | security and privacy plans or equivalent documents. |
| IMPLEMENTATIONS | [Cybersecurity Framework: Profile] |
| TASK S-5 • | A continuous monitoring strategy for the system that reflects the |
| CONTINUOUS MONITORING STRATEGY— | organizational risk management strategy is developed. |
| SYSTEM | [Cybersecurity Framework: ID.GV; DE.CM] |
| TASK S-6 • | Security and privacy plans reflecting the selection of controls |
| PLAN REVIEW AND APPROVAL | necessary to protect the system and the environment of |
...
| Tasks | Outcomes |
| --- | --- |
| TASK I-1 • | Controls specified in the security and privacy plans are |
...
| TASK I-2 • | Changes to the planned implementation of controls are |
| UPDATE CONTROL IMPLEMENTATION | documented. |
| INFORMATION | [Cybersecurity Framework: PR.IP-1] |
...
| Tasks | Outcomes |
| --- | --- |
| • TASK A-1 | An assessor or assessment team is selected to conduct the |
| ASSESSOR SELECTION | control assessments. |
| • | The appropriate level of independence is achieved for the |
|  | assessor or assessment team selected. |
| TASK A-2 • | Documentation needed to conduct the assessments is provided |
| ASSESSMENT PLAN | to the assessor or assessment team. |
...
| TASK A-3 • | Control assessments are conducted in accordance with the |
| CONTROL ASSESSMENTS | security and privacy assessment plans. |
...
| TASK A-4 • | Security and privacy assessment reports that provide findings |
| ASSESSMENT REPORTS | and recommendations are completed. |
| TASK A-5 • | Remediation actions to address deficiencies in the controls |
| REMEDIATION ACTIONS | implemented in the system and environment of operation are |
|  | taken. |
...
|  | [Cybersecurity Framework: Profile] |
| TASK A-6 • | A plan of action and milestones detailing remediation plans for |
| PLAN OF ACTION AND MILESTONES | unacceptable risks identified in security and privacy assessment |
...
Common controls (i.e., controls that are inherited by the system) are assessed separately (by assessors chosen by common control providers or the organization) and need not be assessed as part of a systemlevel assessment.

________________________________________________________________________________________________

Organizations ensure that assessors have access to the information system and environment of operation where the controls are implemented and to the documentation, records, artifacts, test results, and other materials needed to assess the controls. This includes the controls implemented by external providers through contracts, interagency agreements, lines of business arrangements, licensing agreements, or supply chain arrangements. Assessors have the required degree of independence as determined by the authorizing official.91 Assessor independence during the continuous monitoring process facilitates reuse of assessment results to support ongoing authorization and reauthorization.
...
<sup>91</sup> In accordance with [OMB A-130], an independent evaluation of privacy program and practices is not required. However, an organization may choose to employ independent privacy assessments at the organization's discretion. 92 If a comparable report meets the requirements of what is to be included in an assessment report, then the comparable report would itself constitute the assessment report.
...
| Tasks | Outcomes |
| --- | --- |
| • TASK R-1 | An authorization package is developed for submission to the |
| AUTHORIZATION PACKAGE | authorizing official. |
| TASK R-2 • | A risk determination by the authorizing official that reflects the |
| RISK ANALYSIS AND DETERMINATION | risk management strategy including risk tolerance, is rendered. |
| TASK R-3 • | Risk responses for determined risks are provided. |
| RISK RESPONSE | [Cybersecurity Framework: ID.RA-6] |
| • TASK R-4 | The authorization for the system or the common controls is |
| AUTHORIZATION DECISION | approved or denied. |
| TASK R-5 • | Authorization decisions, significant vulnerabilities, and risks are |
| AUTHORIZATION REPORTING | reported to organizational officials. |
...
<sup>98</sup> Organizations decide on the level of detail and the presentation format of security and privacy information that is made available to authorizing officials through automation. Decisions about level of detail and format are based on organizational needs with the automated presentation of security and privacy information tailored to the decisionmaking needs of the authorizing officials. For example, detailed security and privacy information may be generated and collected at the operational level of the organization with information subsequently analyzed, distilled, and presented to authorizing officials in a summarized or highlighted format using automation.
...
| Tasks | Outcomes |
| --- | --- |
| TASK M-1 • | The information system and environment of operation are |
| SYSTEM AND ENVIRONMENT CHANGES | monitored in accordance with the continuous monitoring |
|  | strategy. |
|  | [Cybersecurity Framework: DE.CM; ID.GV] |
| • TASK M-2 | Ongoing assessments of control effectiveness are conducted in |
| ONGOING ASSESSMENTS | accordance with the continuous monitoring strategy. |
|  | [Cybersecurity Framework: ID.SC-4] |
| • TASK M-3 | The output of continuous monitoring activities is analyzed and |
| ONGOING RISK RESPONSE | responded to appropriately. |
|  | [Cybersecurity Framework: RS.AN] |
| TASK M-4 • | Risk management documents are updated based on continuous |
| AUTHORIZATION PACKAGE UPDATES | monitoring activities. |
|  | [Cybersecurity Framework: RS.IM] |
| • TASK M-5 | A process is in place to report the security and privacy posture to |
| SECURITY AND PRIVACY REPORTING | the authorizing official and other senior leaders and executives. |
| TASK M-6 • | Authorizing officials conduct ongoing authorizations using the |
| ONGOING AUTHORIZATION | results of continuous monitoring activities and communicate |
|  | changes in risk determination and acceptance decisions. |
| TASK M-7 • | A system disposal strategy is developed and implemented, as |
| SYSTEM DISPOSAL | needed. |
...
**Potential Inputs:** Security and privacy assessment reports; plans of action and milestones; organizationand system-level risk assessment results; organization- and system-level continuous monitoring strategy; security and privacy plans; Cybersecurity Framework Profile.
...
ppendix B provides definitions for terminology used within Special Publication 800-37. Sources for terms used in this publication are cited as applicable. Where no citation is noted, the source of the definition is Special Publication 800-37. A
...
| --- | --- |
| [ISO 15026, Adapted] | has been or will be achieved. |
...
| [CNSSI 4009] | system accesses and operations performed in a given period. |
| audit trail | A chronological record that reconstructs and examines the |
...
| [FIPS 200] | prerequisite to allowing access to resources in a system. |
...
|  | connected. |
| authorization package | The essential information that an authorizing official uses to |
| [OMB A-130] | determine whether to authorize the operation of an information |
...
| chain of trust | A certain level of trust in supply chain interactions such that each |
| (supply chain) | participant in the consumer-provider relationship provides |
...
| classified national | Information that has been determined pursuant to Executive |
| security information | Order (E.O.) 13526 or any predecessor order to require |
| [CNSSI 4009] | protection against unauthorized disclosure and is marked to |
...
| common control | A security or privacy control that is inherited by multiple |
| [OMB A-130] | information systems or programs. |
...
| [CNSSI 4009] | method for specifying security function and assurance |
...
| [44 USC 3552] | disclosure, including means for protecting personal privacy and |
...
|  | implementation. |
| configuration item | An aggregation of system components that is designated for |
| [SP 800-128] | configuration management and treated as a single entity in the |
|  | configuration management process. |
| configuration | A collection of activities focused on establishing and maintaining |
| management | the integrity of information technology products and systems, |
| [SP 800-128] | through control of processes for initializing, changing, and |
...
| [SP 800-128] | software, or firmware that affect the security posture and/or |
|  | functionality of the system. |
| continuous monitoring | Maintaining ongoing awareness to support organizational risk |
|  | decisions. |
| continuous monitoring | A program established to collect information in accordance with |
| program | preestablished metrics, utilizing information readily available in |
...
| [32 CFR 2002.4] | Government, that a law, regulation, or Government-wide policy |
...
| [OMB A-130] | computers, electronic communications systems, electronic |
...
|  | and nonrepudiation. |
| cybersecurity framework | A risk-based approach to reducing cybersecurity risk composed |
| [NIST CSF] | of three parts: the Framework Core, the Framework Profile, and |
|  | the Framework Implementation Tiers. |
| cybersecurity framework | The subdivision of a Function into groups of cybersecurity |
| category | outcomes, closely tied to programmatic needs and particular |
| [NIST CSF] | activities. |
| cybersecurity framework | A set of cybersecurity activities and references that are common |
| core | across critical infrastructure sectors and are organized around |
| [NIST CSF] | particular outcomes. The Framework Core comprises four types |
|  | of elements: Functions, Categories, Subcategories, and |
|  | Informative References. |
| cybersecurity framework | One of the main components of the Framework. Functions |
| function | provide the highest level of structure for organizing basic |
| [NIST CSF] | cybersecurity activities into Categories and Subcategories. The |
|  | five functions are Identify, Protect, Detect, Respond, and |
|  | Recover. |

________________________________________________________________________________________________

| cybersecurity framework | A representation of the outcomes that a particular system or |
| --- | --- |
| profile | organization has selected from the Framework Categories and |
| [NIST CSF] | Subcategories. |
| cybersecurity framework | The subdivision of a Category into specific outcomes of technical |
| subcategory | and/or management activities. |
| [NIST CSF] |  |
| derived requirements | A requirement that is implied or transformed from a higher-level |
| [SP 800-160 v1] | requirement. |
...
|  | requirement. |
| detect (CSF function) | Develop and implement the appropriate activities to identify the |
| [NIST CSF] | occurrence of a cybersecurity event. |
...
| [CNSSI 4009] | boundary, using systems to execute that mission, and with |
...
| [44 USC 3601] | the information necessary to perform the mission; the |
...
| [OMB A-130] | processes, stores, and transmits information. |
...
| external system (or | A system or system element that is outside of the authorization |
| --- | --- |
| component) | boundary established by the organization and for which the |
...
| federal enterprise | A business-based framework for governmentwide improvement |
| architecture | developed by the Office of Management and Budget that is |
| [OMB FEA] | intended to facilitate efforts to transform the federal |
...
| [CNSSI 4009] | read-only memory (ROM) or programmable read-only memory |
...
| hardware | The material physical components of a system. See software and |
| [CNSSI 4009] | firmware. |
| high-impact system | A system in which at least one security objective (i.e., |
| [FIPS 200] | confidentiality, integrity, or availability) is assigned a FIPS |
|  | Publication 199 potential impact value of high. |
| hybrid control | A security or privacy control that is implemented for an |
| [OMB A-130] | information system in part as a common control and in part as a |
|  | system-specific control. See common control and system-specific |
|  | control. |
| identify (CSF function) | Develop and implement the appropriate activities to identify the |
| [NIST CSF] | occurrence of a cybersecurity event. |
...
| impact value | The assessed worst-case potential impact that could result from |
| [FIPS 199] | a compromise of the confidentiality, integrity, or availability of |
|  | information expressed as a value of low, moderate or high. |
| incident | An occurrence that actually or imminently jeopardizes, without |
| [44 USC 3552] | lawful authority, the confidentiality, integrity, or availability of |
...
| and validation | hardware) performed by an objective third party to confirm (i.e., |
| [CNSSI 4009] | verify) that the requirements are correctly defined, and to |
...
|  | audiovisual forms. |
| information life cycle | The stages through which information passes, typically |
| [OMB A-130] | characterized as creation or collection, processing, |
...
| [44 USC 3502] | equipment, funds, and information technology. |
...
| [OMB A-130] | program and describes the program management controls and |
...
| information system | A formal document that provides an overview of the security |
| security plan | requirements for an information system and describes the |
| [OMB A-130] | security controls in place or planned for meeting those |
|  | requirements. |
...
|  | use. |
| information technology | See system component. |
| product |  |
...
| interface | Common boundary between independent systems or modules |
| [CNSSI 4009] | where interactions take place. |
...
| low-impact system | A system in which all three security objectives (i.e., |
...
| organization-defined | The variable part of a control or control enhancement that can |
| --- | --- |
| control parameter | be instantiated by an organization during the tailoring process by |
...
|  | control enhancement. |
| overlay | A specification of security or privacy controls, control |
| [OMB A-130] | enhancements, supplemental guidance, and other supporting |
...
| information | individual's identity, either alone or when combined with other |
| [OMB A-130] | information that is linked or linkable to a specific individual. |
| plan of action and | A document that identifies tasks needing to be accomplished. It |
| milestones | details resources required to accomplish the elements of the |
...
| [FIPS 199] | expected to have a limited adverse effect (FIPS Publication 199 |
...
| privacy control | The administrative, technical, and physical safeguards employed |
| [OMB A-130] | within an agency to ensure compliance with applicable privacy |
...
| privacy control | The assessment of privacy controls to determine whether the |
| --- | --- |
| assessment | controls are implemented correctly, operating as intended, and |
| [OMB A-130] | sufficient to ensure compliance with applicable privacy |
...
| privacy impact | An analysis of how information is handled to ensure handling |
| assessment | conforms to applicable legal, regulatory, and policy requirements |
| [OMB A-130] | regarding privacy; to determine the risks and effects of creating, |
...
| privacy posture | The privacy posture represents the status of the information |
...
| privacy requirement | A requirement that applies to an information system or an |
| --- | --- |
...
|  | system or organization. |
| protect (CSF function) | Develop and implement the appropriate safeguards to ensure |
| [NIST CSF] | delivery of critical infrastructure services. |
...
|  | information. |
| records | All recorded information, regardless of form or characteristics, |
| [44 USC 3301] | made or received by a Federal agency under Federal law or in |
...
|  | of data in them. |
| recover (CSF function) | Develop and implement the appropriate activities to maintain |
| [NIST CSF] | plans for resilience and to restore any capabilities or services |
...
| [CNSSI 4009] | withstand and recover rapidly from disruptions. Resilience |
...
| respond (CSF function) | Develop and implement the appropriate activities to take action |
| [NIST CSF] | regarding a detected cybersecurity event. |
...
|  | success. |
| risk management | The program and supporting processes to manage risk to agency |
| [OMB A-130] | operations (including mission, functions, image, reputation), |
...
| [CNSSI 4009] | reducing controls/countermeasures recommended from the risk |
|  | management process. |
| risk response | Accepting, avoiding, mitigating, sharing, or transferring risk to |
| [OMB A-130] | agency operations, agency assets, individuals, other |
...
| security architecture | An embedded, integral part of the enterprise architecture that |
| [SP 800-39] | describes the structure and behavior for an enterprise's security |
|  | processes, information security systems, personnel and |
|  | organizational sub-units, showing their alignment with the |
|  | enterprise's mission and strategic plans. See information security |
|  | architecture. |
| [SP 800-160 v1] | A set of physical and logical security-relevant representations |
...
| --- | --- |
| [OMB A-130] | moderate-impact, or high-impact information system. See also |
|  | control baseline. |
...
| [CNSSI 4009] | systems based on information assurance resources (e.g., people, |
...
| information security | responsibilities under FISMA and serving as the Chief |
| officer | Information Officer's primary liaison to the agency's authorizing |
| [44 USC 3544] | officials, information system owners, and information system |
|  | security officers. |
| senior agency official for | The senior official, designated by the head of each agency, who |
| privacy | has agency-wide responsibility for privacy, including |
| [OMB A-130] | implementation of privacy protections; compliance with Federal |
...
| senior accountable official | The senior official, designated by the head of each agency, who |
| --- | --- |
| for risk management | has vision into all areas of the organization and is responsible for |
| [OMB M-17-25] | alignment of information security management processes with |
...
| statement of work | A type of requirement that represents an action that is |
| requirement | performed operationally or during system development. |
...
| [OMB A-130] | developers that begins with the sourcing of products and |
...
| supply chain risk | Risks that arise from the loss of confidentiality, integrity, or |
| [OMB A-130] | availability of information or information systems and reflect the |
...
| supply chain risk | The process of identifying, assessing, and mitigating the risks |
| management | associated with the global and distributed nature of information |
| [OMB A-130] | and communications technology product and service supply |
|  | chains. |
...
| [ISO 15288] | Note 1: A system element can be a discrete component, product, service, |
...
| systems privacy | Process that captures and refines privacy requirements and |
| --- | --- |
| engineering | ensures their integration into information technology |
...
|  | engineering activities. |
| systems security | Process that captures and refines security requirements and |
| engineering | ensures their integration into information technology |
|  | component products and information systems through |
...
| system-related privacy | Risk to an individual or individuals associated with the agency's |
| risk | creation, collection, use, processing, storage, maintenance, |
| [OMB A-130] | dissemination, disclosure, and disposal of their PII. See risk. |
| system-related security | Risk that arises through the loss of confidentiality, integrity, or |
| risk | availability of information or systems and that considers impacts |
| [SP 800-30] | to the organization (including assets, mission, functions, image, |
|  | or reputation), individuals, other organizations, and the Nation. |
|  | See risk. |
| system-specific control | A security or privacy control for an information system that is |
| [OMB A-130] | implemented at the system level and is not inherited by any |
...
| [OMB A-130] | identifying and designating common controls; applying scoping |
...
| (system) | information technology components that are used to build the |
...
| trustworthy information | An information system that is believed to be capable of |
| system | operating within defined levels of risk despite the environmental |
| [OMB A-130] | disruptions, human errors, structural failures, and purposeful |
...
- Security activities required across the organization are accomplished in an efficient, costeffective, and timely manner; and
...
The senior agency official for privacy is responsible for designating which privacy controls may be treated as common controls. Privacy controls that are designated as common controls are documented in the organization's privacy program plan.119 The senior agency official for privacy
...
### **SYSTEMS SECURITYOR PRIVACY ENGINEER**
...
| --- | --- | --- |
| Organization Level |  |  |
| TASK P-1 | • Head of Agency | • Authorizing Official or Authorizing |
| Risk Management Roles | • Chief Information Officer | Official Designated Representative |
| • Senior Agency Official for Privacy |  | • Senior Accountable Official for Risk |
| Identify and assign individuals to |  | Management or Risk Executive |
| specific roles associated with |  | (Function) |
| security and privacy risk |  | • Senior Agency Information Security |
| management. |  | Officer |
| TASK P-2 | • Head of Agency | • Senior Accountable Official for Risk |
|  |  | Management or Risk Executive |
| Risk Management Strategy |  | (Function) |
| Establish a risk management |  | • Chief Information Officer |
| strategy for the organization |  | • Senior Agency Information Security |
| that includes a determination of |  | Officer |
| risk tolerance. |  | • Senior Agency Official for Privacy |
| TASK P-3 | • Senior Accountable Official for Risk | • Chief Information Officer |
| Management or Risk Executive |  | • Authorizing Official or Authorizing |
| Risk Assessment—Organization | (Function) | Official Designated Representative |
| Assess organization-wide | • Senior Agency Information Security | • Mission or Business Owner |
| security and privacy risk and | Officer |  |
| update the risk assessment | • Senior Agency Official for Privacy |  |
| results on an ongoing basis. |  |  |
| TASK P-4 | • Mission or Business Owner | • Chief Information Officer |
| Organizationally-Tailored | • Senior Accountable Official for Risk | • Authorizing Official or Authorizing |
| Management or Risk Executive |  | Official Designated Representative |
| Control Baselines and | (Function) | • Senior Agency Information Security |
| Cybersecurity Framework |  |  |
| Profiles (Optional) |  | Officer |
|  |  | • Senior Agency Official for Privacy |
...
| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK P-5 | • Senior Agency Information Security | • Mission or Business Owner |
| Common Control Identification | Officer | • Senior Accountable Official for Risk |
|  | • Senior Agency Official for Privacy | Management or Risk Executive |
| Identify, document, and publish |  | (Function) |
| organization-wide common |  | • Chief Information Officer |
| controls that are available for |  | • Authorizing Official or Authorizing |
| inheritance by organizational |  | Official Designated Representative |
| systems. |  | • Common Control Provider |
|  |  | • System Owner |
| TASK P-6 | • Senior Accountable Official for Risk | • Senior Agency Information Security |
|  | Management or Risk Executive | Officer |
| Impact-Level Prioritization (Optional) | (Function) | • Senior Agency Official for Privacy |
|  |  | • Mission or Business Owner |
| Prioritize organizational systems |  | • System Owner |
| with the same impact level. |  | • Chief Information Officer |
|  |  | • Authorizing Official or Authorizing |
|  |  | Official Designated Representative |
| TASK P-7 | • Senior Accountable Official for Risk | • Chief Information Officer |
| Continuous Monitoring | Management or Risk Executive | • Senior Agency Information Security |
| Strategy—Organization | (Function) | Officer |
|  |  | • Senior Agency Official for Privacy |
| Develop and implement an |  | • Mission or Business Owner |
| organization-wide strategy for |  |  |
|  |  | • System Owner |
| continuously monitoring control |  | • Authorizing Official or Authorizing |
| effectiveness. |  | Official Designated Representative |
|  | System Level |  |
| TASK P-8 | • Mission or Business Owner | • Authorizing Official or Authorizing |
|  |  | Official Designated Representative |
| Mission or Business Focus |  | • System Owner |
| Identify the missions, business |  |  |
| functions, and mission/business |  | • Information Owner or Steward |
|  |  | • Chief Information Officer |
| processes that the system is |  | • Senior Agency Information Security |
| intended to support. |  | Officer |
|  |  | • Senior Agency Official for Privacy |
| TASK P-9 | • Mission or Business Owner | • Chief Information Officer |
|  | • System Owner | • Authorizing Official or Authorizing |
| System Stakeholders |  | Official Designated Representative |
| Identify stakeholders who have |  | • Information Owner or Steward |
| an interest in the design, |  | • Senior Agency Information Security |
| development, implementation, |  | Officer |
| assessment, operation, |  | • Senior Agency Official for Privacy |
| maintenance, or disposal of the |  | • Chief Acquisition Officer |
| system. |  |  |
...
| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK P-10 | • System Owner | • Authorizing Official or Authorizing |
|  |  | Official Designated Representative |
| Asset Identification |  | • Mission or Business Owner |
| Identify assets that require |  | • Information Owner or Steward |
| protection. |  | • Senior Agency Information Security |
|  |  | Officer |
|  |  | • Senior Agency Official for Privacy |
|  |  | • System Administrator |
| TASK P-11 | • Authorizing Official | • Chief Information Officer |
| Authorization Boundary |  | • Mission or Business Owner |
|  |  | • System Owner |
| Determine the authorization |  | • Senior Agency Information Security |
| boundary of the system. |  | Officer |
|  |  | • Senior Agency Official for Privacy |
|  |  | • Enterprise Architect |
| TASK P-12 | • System Owner | • System Security Officer |
| Information Types | • Information Owner or Steward | • System Privacy Officer |
|  |  | • Mission or Business Owner |
| Identify the types of information |  |  |
| to be processed, stored, and |  |  |
| transmitted by the system. |  |  |
| TASK P-13 | • Senior Agency Official for Privacy | • Chief Information Officer |
| Information Life Cycle | • System Owner | • Mission or Business Owner |
|  | • Information Owner or Steward | • Security Architect |
| Identify and understand all |  |  |
|  |  | • Privacy Architect |
| stages of the information life |  | • Enterprise Architect |
| cycle for each information type |  | • Systems Security Engineer |
| processed, stored, or |  | • Privacy Engineer |
| transmitted by the system. |  |  |
| TASK P-14 | • System Owner | • Senior Accountable Official for Risk |
|  | • System Security Officer | Management or Risk Executive |
| Risk Assessment—System | • System Privacy Officer | (Function) |
| Conduct a system-level risk |  | • Authorizing Official or Authorizing |
| assessment and update the risk |  | Official Designated Representative |
| assessment results on an |  | • Mission or Business Owner |
| ongoing basis. |  | • Information Owner or Steward |
|  |  | • System Security Officer |
| TASK P-15 | • Mission or Business Owner | • Authorizing Official or Authorizing |
|  | • System Owner | Official Designated Representative |
| Requirements Definition | • Information Owner or Steward | • Senior Agency Information Security |
| Define the security and privacy |  |  |
|  | • System Privacy Officer | Officer |
| requirements for the system |  | • Senior Agency Official for Privacy |
| and the environment of |  | • System Security Officer |
| operation. |  | • Chief Acquisition Officer |
|  |  | • Security Architect |
|  |  | • Privacy Architect |
|  |  | • Enterprise Architect |
...
| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK P-16 | • Mission or Business Owner | • Chief Information Officer |
| Enterprise Architecture | • Enterprise Architect • Security Architect | • Authorizing Official or Authorizing Official Designated Representative |
| Determine the placement of the system within the enterprise | • Privacy Architect | • Senior Agency Information Security |
|  |  | Officer |
| architecture. |  | • Senior Agency Official for Privacy |
|  |  | • System Owner |
|  |  | • Information Owner or Steward |
| TASK P-17 | • Security Architect | • Chief Information Officer |
| Requirements Allocation | • Privacy Architect | • Authorizing Official or Authorizing |
|  | • System Security Officer | Official Designated Representative |
| Allocate security and privacy | • System Privacy Officer | • Mission or Business Owner |
| requirements to the system and to the environment of |  | • Senior Agency Information Security |
|  |  | Officer |
| operation. |  | • Senior Agency Official for Privacy |
|  |  | • System Owner |
| TASK P-18 | • System Owner | • Mission or Business Owner |
| System Registration |  | • Chief Information Officer |
|  |  | • System Security Officer |
| Register the system with |  | • System Privacy Officer |
...
| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK C-1 | System Owner | • Authorizing Official or Authorizing |
| System Description |  | Official Designated Representative |
|  |  | • Information Owner or Steward |
| Document the characteristics of the |  | • System Security Officer |
| system. |  | • System Privacy Officer |
| TASK C-2 | • System Owner | • Senior Accountable Official for Risk |
| Security Categorization | • Information Owner or Steward | Management or Risk Executive (Function) |
| document the security |  |  |
| Categorize the system and |  | • Chief Information Officer |
|  |  | • Senior Agency Information Security |
| categorization results. |  | Officer |
|  |  | • Authorizing Official or Authorizing |
|  |  | Official Designated Representative |
|  |  | • System Security Officer |
|  |  | • System Privacy Officer |
| TASK C-3 | • Authorizing Official or | • Senior Accountable Official for Risk |
| Security Categorization Review and | Authorizing Official Designated | Management or Risk Executive |
|  | Representative | (Function) |
| Approval | • Senior Agency Official for Privacy | • Chief Information Officer |
| Review and approve the security categorization results and decision. | (for systems processing PII) | • Senior Agency Information Security |
|  |  | Officer |

### ________________________________________________________________________________________________ **TABLE E-2: CATEGORIZATION TASKS, RESPONSIBILITIES, AND SUPPORTING ROLES**

| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK S-1 | • System Owner | • Authorizing Official or Authorizing |
|  | • Common Control Provider | Official Designated Representative |
| Control Selection |  | • Information Owner or Steward |
| Select the controls for the system |  | • Systems Security Engineer |
| and the environment of operation. |  | • Privacy Engineer |
|  |  | • System Security Officer |
|  |  | • System Privacy Officer |
| TASK S-2 | • System Owner | • Authorizing Official or Authorizing |
|  | • Common Control Provider | Official Designated Representative |
| Control Tailoring |  | • Information Owner or Steward |
| Tailor the controls selected for the |  | • Systems Security Engineer |
| system and the environment of |  |  |
|  |  | • Privacy Engineer |
| operation. |  | • System Security Officer |
|  |  | • System Privacy Officer |
| TASK S-3 | • Security Architect | • Chief Information Officer |
| Control Allocation | • Privacy Architect | • Authorizing Official or Authorizing |
|  | • System Security Officer | Official Designated Representative |
| Allocate security and privacy | • System Privacy Officer | • Mission or Business Owner |
| controls to the system and to the |  | • Senior Agency Information Security |
| environment of operation. |  | Officer |
|  |  | • Senior Agency Official for Privacy |
|  |  | • System Owner |
| TASK S-4 | • System Owner | • Authorizing Official or Authorizing |
| Documentation of Planned Control | • Common Control Provider | Official Designated Representative |
|  |  | • Information Owner or Steward |
| Implementations |  | • Systems Security Engineer |
| Document the controls for the |  | • Privacy Engineer |
| system and environment of |  | • System Security Officer |
| operation in security and privacy |  | • System Privacy Officer |
| plans. |  |  |
| TASK S-5 | • System Owner | • Senior Accountable Official for Risk |
|  | • Common Control Provider | Management or Risk Executive |
| Continuous Monitoring Strategy— |  |  |
| System |  | (Function) • Chief Information Officer |
| Develop and implement a system |  | • Senior Agency Information Security |
| level strategy for monitoring control |  | Officer |
| effectiveness that is consistent with |  | • Senior Agency Official for Privacy |
| and supplements the organizational |  |  |
|  |  | • Authorizing Official or Authorizing |
| continuous monitoring strategy. |  | Official Designated Representative |
|  |  | • Information Owner or Steward |
|  |  | • Security Architect |
|  |  | • Privacy Architect |
...
### ________________________________________________________________________________________________ **TABLE E-3: SELECTION TASKS, RESPONSIBILITIES, AND SUPPORTING ROLES**

| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK S-6 | • Authorizing Official or | • Senior Accountable Official for Risk |
|  | Authorizing Official Designated | Management or Risk Executive |
| Plan Review and Approval | Representative | (Function) |
| Review and approve the security |  | • Chief Information Officer |
| and privacy plans for the system |  | • Senior Agency Information Security |
...
| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK I-1 | • System Owner • Common Control Provider | • Information Owner or Steward • Security Architect |
| Control Implementation |  | • Privacy Architect |
| Implement the controls in the |  |  |
|  |  | • Systems Security Engineer |
| security and privacy plans. |  | • Privacy Engineer |
|  |  | • System Security Officer |
|  |  | • System Privacy Officer |
|  |  | • Enterprise Architect |
|  |  | • System Administrator |
| TASK I-2 | • System Owner | • Information Owner or Steward |
| Update Control Implementation | • Common Control Provider | • Security Architect |
| Information |  | • Privacy Architect |
|  |  | • Systems Security Engineer |
| Document changes to planned control implementations based on |  | • Privacy Engineer |
| the "as-implemented" state of |  | • System Security Officer |
|  |  | • System Privacy Officer |
| controls. |  | • Enterprise Architect |
|  |  | • System Administrator |

### ________________________________________________________________________________________________ **TABLE E-4: IMPLEMENTATION TASKS, RESPONSIBILITIES, AND SUPPORTING ROLES**

| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK A-1 | • Authorizing Official or Authorizing | • Chief Information Officer |
|  | Official Designated Representative | • Senior Agency Information Security |
| Assessor Selection |  | Officer |
| Select the appropriate assessor |  | • Senior Agency Official for Privacy |
| or assessment team for the type |  |  |
| of control assessment to be |  |  |
| conducted. |  |  |
| TASK A-2 | • Authorizing Official or Authorizing | • Senior Agency Information Security |
|  | Official Designated Representative | Officer |
| Assessment Plan | • Control Assessor | • Senior Agency Official for Privacy |
| Develop, review, and approve |  | • System Owner |
| plans to assess implemented |  | • Common Control Provider |
| controls. |  | • Information Owner or Steward |
|  |  | • System Security Officer |
|  |  | • System Privacy Officer |
| TASK A-3 | • Control Assessor | • Authorizing Official or Authorizing |
|  |  | Official Designated Representative |
| Control Assessments |  | • System Owner |
| Assess the controls in accordance |  | • Common Control Provider |
| with the assessment procedures |  | • Information Owner or Steward |
| described in assessment plans. |  | • Senior Agency Information Security |
|  |  | Officer |
|  |  | • Senior Agency Official for Privacy |
|  |  | • System Security Officer |
|  |  | • System Privacy Officer |
| TASK A-4 | • Control Assessor | • System Owner |
| Assessment Reports |  | • Common Control Provider |
|  |  | • System Security Officer |
| Prepare the assessment reports |  | • System Privacy Officer |
| documenting the findings and |  |  |
| recommendations from the |  |  |
| control assessments. |  |  |
| TASK A-5 | • System Owner | • Authorizing Official or Authorizing |
|  | • Common Control Provider | Official Designated Representative |
| Remediation Actions | • Control Assessor | • Senior Agency Information Security |
| Conduct initial remediation |  | Officer |
| actions on the controls and |  | • Senior Agency Official for Privacy |
| reassess remediated controls. |  | • Senior Accountable Official for Risk |
|  |  | Management or Risk Executive |
|  |  | (Function) |
|  |  | • Information Owner or Steward |
|  |  | • Systems Security Engineer |
...
### ________________________________________________________________________________________________ **TABLE E-5: ASSESSMENT TASKS, RESPONSIBILITIES, AND SUPPORTING ROLES**

| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK A-6 | • System Owner | • Information Owner or Steward |
| Plan of Action and Milestones | • Common Control Provider | • System Security Officer |
|  |  | • System Privacy Officer |
| Prepare the plan of action and |  | • Senior Agency Information Security |
| milestones based on the findings |  | Officer |
| and recommendations of the |  | • Senior Agency Official for Privacy |
| assessment reports. |  | • Chief Acquisition Officer |
|  |  | • Control Assessor |
...
| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK R-1 | • System Owner | • System Security Officer |
| Authorization Package | • Common Control Provider | • System Privacy Officer |
|  |  | • Senior Agency Information |
| Assemble the authorization |  | Security Officer |
| package and submit the package |  | • Senior Agency Official for Privacy |
| to the authorizing official for an |  | • Control Assessor |
| authorization decision. |  |  |
| TASK R-2 | • Authorizing Official or Authorizing | • Senior Accountable Official for |
|  | Official Designated Representative | Risk Management or Risk |
| Risk Analysis and Determination |  | Executive (Function) |
| Analyze and determine the risk |  | • Senior Agency Information |
| from the operation or use of the |  | Security Officer |
| system or the provision of |  | • Senior Agency Official for Privacy |
| common controls. |  |  |
| TASK R-3 | • Authorizing Official or Authorizing | • Senior Accountable Official for |
|  | Official Designated Representative | Risk Management or Risk |
| Risk Response |  | Executive (Function) |
| Identify and implement a |  | • Senior Agency Information |
| preferred course of action in |  | Security Officer |
| response to the risk determined. |  | • Senior Agency Official for Privacy |
...
|  |  | • System Security Officer |
|  |  | • System Privacy Officer |
| TASK R-4 | • Authorizing Official | • Senior Accountable Official for |
| Authorization Decision |  | Risk Management or Risk |
|  |  | Executive (Function) |
| Determine if the risk from the |  | • Chief Information Officer |
| operation or use of the |  | • Senior Agency Information |
| information system or the |  | Security Officer |
| provision or use of common |  | • Senior Agency Official for Privacy |
| controls is acceptable. |  | • Authorizing Official Designated |
|  |  | Representative |
| TASK R-5 | • Authorizing Official or Authorizing | • System Owner or Common |
| Authorization Reporting | Official Designated Representative | Control Provider |
|  |  | • Information Owner or Steward |
| Report the authorization decision |  | • System Security Officer |
| and any deficiencies in controls |  | • System Privacy Officer |
| that represent significant security |  | • Senior Agency Information |
| or privacy risk. |  | Security Officer |
|  |  | • Senior Agency Official for Privacy |

### ________________________________________________________________________________________________ **TABLE E-6: AUTHORIZATION TASKS, RESPONSIBILITIES, AND SUPPORTING ROLES**

| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK M-1 | • System Owner or Common | • Senior Accountable Official for Risk |
|  | Control Provider | Management or Risk Executive |
| System and Environment Changes | • Senior Agency Information | (Function) |
| Monitor the information system |  |  |
| and its environment of operation | Security Officer | • Authorizing Official or Authorizing |
|  | • Senior Agency Official for Privacy | Official Designated Representative |
| for changes that impact the security |  | • Information Owner or Steward |
| and privacy posture of the system. |  | • System Security Officer |
|  |  | • System Privacy Officer |
| TASK M-2 | • Control Assessor | • Authorizing Official or Authorizing |
| Ongoing Assessments |  | Official Designated Representative |
|  |  | • System Owner or Common Control |
| Assess the controls implemented |  | Provider |
| within and inherited by the system |  | • Information Owner or Steward |
| in accordance with the continuous |  | • System Security Officer |
| monitoring strategy. |  | • System Privacy Officer |
|  |  | • Senior Agency Information Security |
|  |  | Officer |
|  |  | • Senior Agency Official for Privacy |
| TASK M-3 | • Authorizing Official | • Senior Accountable Official for Risk |
| Ongoing Risk Response | • System Owner | Management or Risk Executive |
|  | • Common Control Provider | (Function) |
| Respond to risk based on the results |  | • Senior Agency Information Security |
| of ongoing monitoring activities, |  | Officer |
| risk assessments, and outstanding |  | • Senior Agency Official for Privacy; |
| items in plans of action and |  | Authorizing Official Designated |
| milestones. |  |  |
|  |  | Representative |
|  |  | • Information Owner or Steward |
|  |  | • System Security Officer |
...
|  |  | • Security Architect |
|  |  | • Privacy Architect |
| TASK M-4 | • System Owner | • Information Owner or Steward |
| Authorization Package Updates | • Common Control Provider | • System Security Officer |
|  |  | • System Privacy Officer |
| Update plans, assessment reports, |  | • Senior Agency Official for Privacy |
| and plans of action and milestones |  | • Senior Agency Information Security |
| based on the results of the |  | Officer |
| continuous monitoring process. |  |  |

### ________________________________________________________________________________________________ **TABLE E-7: MONITORING TASKS, RESPONSIBILITIES, AND SUPPORTING ROLES**

| RMF TASKS | PRIMARY RESPONSIBILITY | SUPPORTING ROLES |
| --- | --- | --- |
| TASK M-5 | • System Owner | • System Security Officer |
|  | • Common Control Provider | • System Privacy Officer |
| Security and Privacy Reporting | • Senior Agency Information |  |
| Report the security and privacy | Security Officer |  |
| posture of the system to the | • Senior Agency Official for Privacy |  |
...
| monitoring strategy. |  |  |
| TASK M-6 | • Authorizing Official | • Senior Accountable Official for Risk |
|  |  | Management or Risk Executive |
| Ongoing Authorization |  | (Function) |
| Review the security and privacy |  | • Chief Information Officer |
| posture of the system on an |  | • Senior Agency Information Security |
| ongoing basis to determine whether |  | Officer |
| the risk remains acceptable. |  |  |
|  |  | • Senior Agency Official for Privacy |
|  |  | • Authorizing Official Designated |
|  |  | Representative |
| TASK M-7 | • System Owner | • Authorizing Official or Authorizing |
|  |  | Official Designated Representative |
| System Disposal |  | • Information Owner or Steward |
| Implement a system disposal |  | • System Security Officer |
| strategy and execute required |  | • System Privacy Officer |
| actions when a system is removed |  |  |
| from operation. |  | • Senior Accountable Official for Risk |
|  |  | Management or Risk Executive |
|  |  | (Function) |
|  |  | • Senior Agency Information Security |
|  |  | Officer |
...
his appendix provides information on the system and common control authorization processes to include: types of authorizations; content of authorization packages; authorization decisions; authorization decision documents; ongoing authorization; reauthorization; event-driven triggers and significant changes; type and facility authorizations; and authorization approaches. T
...
- *Initial authorization* is defined as the initial (start-up) risk determination and risk acceptance decision based on a complete, zero-based review of the system or of common controls. The zero-based review of the system includes an assessment of all implemented system-level controls (including the system-level portion of the hybrid controls) and a review of the security status of inherited common controls as specified in security and privacy plans.126 The zero-based review of common controls (other than common controls that are systembased) includes an assessment of applicable controls (e.g., policies, operating procedures, implementation information) that contribute to the provision of a common control or set of common controls.
...
Supporting the near real-time risk management objectives of the authorization process, the assessment reports are updated on an ongoing basis whenever changes are made to the controls implemented within or inherited by the system.134 Updates to the assessment reports
...
An authorization to use requires the customer organization to review the authorization package from the provider organization as the fundamental basis for determining risk.143 When
...
customer organization if there is a significant event that compromises or adversely affects the customer organization's information. 145
...
common controls are authorized on a time-driven basis in accordance with the authorization frequency determined as part of the organization- and system-level continuous monitoring strategies. The system and common controls are authorized on an event-driven basis until organizational-defined trigger events occur. Whether the authorization is time-driven or eventdriven, the authorizing official acknowledges the ongoing acceptance of identified risks. The organization determines the level of formality required for such acknowledgement by the authorizing official.
...
- An organizational continuous monitoring program is in place that monitors implemented controls with the appropriate degree of rigor and at the required frequencies specified by the organization in accordance with the continuous monitoring strategy and NIST standards and guidelines.151
...
in conjunction with authorized site-specific controls160 or with a facility authorization as described below. A type authorization is issued by the authorizing official responsible for the development of the system161 and represents an authorization to operate. At the site or facility where the system is deployed, the authorizing official who is responsible for the system at the site or facility accepts the risk of deploying the system and issues an authorization to use. The authorization to use leverages the information in the authorization packages for the archetype system and the facility common controls.

________________________________________________________________________________________________

A *facility authorization* is an official authorization decision that is focused on specific controls implemented in a defined environment of operation to support one or more systems residing within that environment. A facility authorization addresses common controls within a facility and allows systems residing in the defined environment to inherit the common controls and the affected system security and privacy plans to reference the authorization package for the facility. The common controls are provided at a specified impact level to facilitate risk decisions on whether it is appropriate to locate a given system in a particular facility.162 Physical and environmental controls are addressed in a facility authorization but other controls may also be included, for example, boundary protections; contingency plan and incident response plan for the facility; or training and awareness and personnel screening for facility staff. The facility authorizing official issues a common control authorization to describe the common controls available for inheritance by systems residing within the facility.
...
When the security categorizations for the identified subsystems are different (e.g., low-impact versus high-impact), the organization examines the subsystem interfaces,164 information flows, and security and privacy dependencies among subsystems and selects the appropriate controls
...
ll systems, including operational systems, systems under development, and systems that are undergoing modification or upgrade, are in some phase of the SDLC. 166Defining requirements is a critical part of an SDLC process and begins in the *initiation* phase.167 Security and privacy requirements are part of the functional and nonfunctional168 requirements allocated to a system. The security and privacy requirements are incorporated into the SDLC simultaneously with the other requirements. Without the early integration of security and privacy requirements, significant expense may be incurred by the organization later in the life cycle to address security and privacy concerns that could have been included in the initial design. When security and privacy requirements are defined early in the SDLC and integrated with other system requirements, the resulting system has fewer deficiencies, and therefore, fewer privacy risks or security vulnerabilities that can be exploited in the future. A
