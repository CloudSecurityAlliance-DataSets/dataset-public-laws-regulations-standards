...
See also: https://www.itu.int/rec/T-REC-X.680; https://www.itu.int/rec/T-REC-X.681; https://www.itu.int/rec/T-REC-X.682; https://www.itu.int/rec/T-REC-X.683
...
OSSL_PROVIDER-base(7) (../OSSL_PROVIDER-base/)

See also: ../OSSL_PROVIDER-base/

## Decoder

A decoder is a type of algorithm used for decoding keys and parameters from some external format such as PEM or DER.

OSSL_DECODER_CTX_new_for_pkey(3) (../../man3/OSSL_DECODER_CTX_new_for_pkey/)

See also: ../../man3/OSSL_DECODER_CTX_new_for_pkey/
...
OSSL_PROVIDER-default(7) (../OSSL_PROVIDER-default/)

See also: ../OSSL_PROVIDER-default/
...
See also: https://www.itu.int/rec/T-REC-X.690

## Encoder

An encoder is a type of algorithm used for encoding keys and parameters to some external format such as PEM or DER.

OSSL_ENCODER_CTX_new_for_pkey(3) (../../man3/OSSL_ENCODER_CTX_new_for_pkey/)

See also: ../../man3/OSSL_ENCODER_CTX_new_for_pkey/

## Explicit Fetching

Explicit Fetching is a type of Fetching (see Fetching). Explicit Fetching is where a function call is made to obtain an algorithm object representing an implementation such as EVP_MD_fetch(3) (../../man3/EVP_DigestInit/) or EVP_CIPHER_fetch(3) (../../man3/EVP_EncryptInit/)

See also: ../../man3/EVP_DigestInit/; ../../man3/EVP_EncryptInit/
...
OSSL_PROVIDER-FIPS(7) (../OSSL_PROVIDER-FIPS/)

See also: ../OSSL_PROVIDER-FIPS/

## Implicit Fetching

Implicit Fetching is a type of Fetching (see Fetching). Implicit Fetching is where an algorithm object with no associated implementation is used such as the return value from EVP_sha256(3) (../../man3/EVP_sha224/) or EVP_aes_128_cbc(3) (../../man3/EVP_aes_128_gcm/). With implicit fetching an implementation is fetched automatically using default selection criteria the first time the algorithm is used.

See also: ../../man3/EVP_sha224/; ../../man3/EVP_aes_128_gcm/

## Legacy Provider

An OpenSSL Provider that contains algorithm implementations that are considered insecure or are no longer in common use.

OSSL_PROVIDER-legacy(7) (../OSSL_PROVIDER-legacy/)

See also: ../OSSL_PROVIDER-legacy/
...
OSSL_LIB_CTX(3) (../../man3/OSSL_LIB_CTX/)

See also: ../../man3/OSSL_LIB_CTX/
...
OSSL_PROVIDER-null(7) (../OSSL_PROVIDER-null/)

See also: ../OSSL_PROVIDER-null/
...
See also: https://tools.ietf.org/html/rfc1421
...
See also: https://tools.ietf.org/html/rfc5208
...
See also: https://tools.ietf.org/html/rfc5280
