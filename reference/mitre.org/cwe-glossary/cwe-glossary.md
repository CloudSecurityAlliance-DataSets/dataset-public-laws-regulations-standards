...
Adversary-in-the-Middle. Formerly MITM.

Source: <https://cwe.mitre.org/documents/glossary/#AITM>

---

## Activation Point

a vulnerability theory term for the location in code at which an attacker's "payload" can be executed, i.e., when the attacker has caused the code to violate the intended security policy. For example, in SQL injection, the code reads an input from a parameter (interaction point); incorrectly checks the input for dangerous characters (crossover point); inserts the input into a dynamically generated query string; then sends the query string to the database server (trigger point); then the query is processed by the server (activation point). See the Vulnerability Theory paper for more details.

Source: <https://cwe.mitre.org/documents/glossary/#Activation%20Point>
...
Source: <https://cwe.mitre.org/documents/glossary/#Actor>

---

## Adversary-in-the-Middle

an adversary who is able to eavesdrop, intercept, and/or possibly modify the communications between two parties by having access to an intermediary system through which communication must flow between the two parties, e.g., a router in between a client and server. Formerly Man-in-the-Middle / MITM.

Source: <https://cwe.mitre.org/documents/glossary/#Adversary-in-the-Middle>
...
Source: <https://cwe.mitre.org/documents/glossary/#Allowlist>
...
Source: <https://cwe.mitre.org/documents/glossary/#Attack%20Pattern>
...
Source: <https://cwe.mitre.org/documents/glossary/#Attacker>
...
Source: <https://cwe.mitre.org/documents/glossary/#Authentication>
...
Source: <https://cwe.mitre.org/documents/glossary/#Authorization>
...
Source: <https://cwe.mitre.org/documents/glossary/#Base%20Weakness>

---

## Behavior

an action that the product takes, typically as implemented in code or as represented by an algorithm. This could also refer to actions by other actors that are not the system.

Source: <https://cwe.mitre.org/documents/glossary/#Behavior>

---

## Business Logic

A frequently-used term whose use is discouraged in CWE. This term is generally used to describe issues that require domain-specific knowledge or "business rules" to determine if they are weaknesses or vulnerabilities, instead of legitimate behavior. Such issues might not be easily detectable via automatic code analysis, because the associated operations do not produce clear errors or undefined behavior at the code level.

Source: <https://cwe.mitre.org/documents/glossary/#Business%20Logic>
...
Source: <https://cwe.mitre.org/documents/glossary/#CRUD>

---

## Callable

an abstract term for a function, method, procedure, etc. that can be explicitly invoked by its name. also known as "Callable Element" (adapted from CISQ).

Source: <https://cwe.mitre.org/documents/glossary/#Callable>
...
Source: <https://cwe.mitre.org/documents/glossary/#Canonicalization>
...
Source: <https://cwe.mitre.org/documents/glossary/#Canonicalize>
...
Source: <https://cwe.mitre.org/documents/glossary/#Category>
...
Source: <https://cwe.mitre.org/documents/glossary/#Chain>
...
Source: <https://cwe.mitre.org/documents/glossary/#Check>
...
Source: <https://cwe.mitre.org/documents/glossary/#Class%20Weakness>
...
Source: <https://cwe.mitre.org/documents/glossary/#Cleanse>

---

## Cleansing

This term is discouraged for use in CWE. See "Cleanse".

Source: <https://cwe.mitre.org/documents/glossary/#Cleansing>
...
Source: <https://cwe.mitre.org/documents/glossary/#Consequence>

---

## Control Element

an abstract term for a function, method, procedure, etc. (adapted from CISQ).

Source: <https://cwe.mitre.org/documents/glossary/#Control%20Element>
...
Source: <https://cwe.mitre.org/documents/glossary/#Control%20Sphere>
...
Source: <https://cwe.mitre.org/documents/glossary/#Crossover%20Point>
...
Source: <https://cwe.mitre.org/documents/glossary/#Denylist>

---

## Enforce

a general term, meaning to check or manipulate a resource so that it has a property that is required by the security policy. For example, the removal of all non-alphanumeric characters from an input is one mechanism to enforce that "all characters are alphanumeric." An alternate method of enforcement would be to reject the input entirely if it contains anything that's non-alphanumeric.

Source: <https://cwe.mitre.org/documents/glossary/#Enforce>
...
Source: <https://cwe.mitre.org/documents/glossary/#Entry>
...
Source: <https://cwe.mitre.org/documents/glossary/#Equivalence>

---

## Explicit Slice

a view Slice whose membership is determined by some external criterion that is represented using HasMember relationships between the view and those entries, but not between entries themselves. An example is CWE-635, which lists the CWE identifiers that were used by NVD from 2008 to 2016.

Source: <https://cwe.mitre.org/documents/glossary/#Explicit%20Slice>
...
Source: <https://cwe.mitre.org/documents/glossary/#Filter>
...
Source: <https://cwe.mitre.org/documents/glossary/#Filtering>
...
Source: <https://cwe.mitre.org/documents/glossary/#Graph>
...
Source: <https://cwe.mitre.org/documents/glossary/#Handle>

---

## ICTA

Interaction/Crossover/Trigger/Activation, an acronym for the vulnerability theory terms for important locations in code artifacts (Interaction Point, Crossover Point, Trigger Point, Activation Point).

Source: <https://cwe.mitre.org/documents/glossary/#ICTA>

---

## IP

Internet Protocol (in networking); Intellectual Property (in hardware).

Source: <https://cwe.mitre.org/documents/glossary/#IP>

---

## Implicit Slice

a view Slice that defines its membership based on common characteristics of entries, such as weaknesses that can appear in C programs (CWE-658). Implicit slices use a "Filter" query that determines which entries are members of the view.

Source: <https://cwe.mitre.org/documents/glossary/#Implicit%20Slice>

---

## Improper

used as a catch-all term to cover security behaviors that are either "Missing" or "Insufficient/Incorrect." Note: CWE began adopting this term with CWE 1.2.

Source: <https://cwe.mitre.org/documents/glossary/#Improper>

---

## Incorrect

a general term, used to describe when a behavior attempts to do a task but does not do it correctly. This is distinct from "Missing," in which the the behavior is not even performed. This is similar to "Insufficient." Note: CWE began adopting this term with CWE 1.2.

Source: <https://cwe.mitre.org/documents/glossary/#Incorrect>
...
Source: <https://cwe.mitre.org/documents/glossary/#Information%20Exposure>

---

## Insecure

Use of this term is discouraged in names and descriptions for CWE weaknesses. It does not provide any hint about the actual error that was introduced by the developer. Some unreviewed entries may still use this term, although it will be corrected in future versions of CWE. This is a general term used to describe a behavior that is incorrect and has security implications.

Source: <https://cwe.mitre.org/documents/glossary/#Insecure>

---

## Insufficient

a general term used to describe when a security property or behavior can vary in strength on a continuous or sliding scale, instead of a discrete scale. The continuous scale may vary depending on the context and risk tolerance. For example, the requirements for randomness may vary between a random selection for a greeting message versus the generation of a strong cryptographic key. On the other hand, a weakness that allows a buffer overflow is always incorrect - there is not a sliding scale that varies across contexts. Note: this this term has been used inconsistently in CWE, although it was more clearly defined beginning in CWE 1.4.

Source: <https://cwe.mitre.org/documents/glossary/#Insufficient>
...
Source: <https://cwe.mitre.org/documents/glossary/#Interaction%20Point>
...
Source: <https://cwe.mitre.org/documents/glossary/#Internal>
...
Source: <https://cwe.mitre.org/documents/glossary/#Invokable%20Element>
...
Source: <https://cwe.mitre.org/documents/glossary/#Leading>

---

## Loose Composite

an informal term for describing a CWE entry that the general public thinks of as an individual weakness, but is actually a disjoint list of multiple distinct weaknesses - i.e., a narrowly-defined category. An example of a loose composite is "insecure temporary file" - the temporary file could have permissions problems, be used as a semaphore, be part of a race condition, etc. This term was more frequently used in CWE's early years.

Source: <https://cwe.mitre.org/documents/glossary/#Loose%20Composite>

---

## MAID

Modification of Assumed-Immutable Data. Originating in the early years of CWE, this describes a case in which the developer (and the code) incorrectly assumes that certain data cannot be modified or influenced by an adversary.

Source: <https://cwe.mitre.org/documents/glossary/#MAID>
...
Source: <https://cwe.mitre.org/documents/glossary/#Manipulation>

---

## Method Control Element

an abstract term for a method that can be explicitly invoked by its name. See "Callable Element" (adapted from CISQ).

Source: <https://cwe.mitre.org/documents/glossary/#Method%20Control%20Element>

---

## Missing

used to describe a behavior that the developer has not attempted to perform. This is distinct from "incorrect," which describes when the developer attempts to perform the behavior, but does not do it correctly. Note: this term was used inconsistently in CWE, although it has been more clearly defined since CWE 1.2.

Source: <https://cwe.mitre.org/documents/glossary/#Missing>
...
Source: <https://cwe.mitre.org/documents/glossary/#Named%20Chain>

---

## Natural Hierarchy

the term used in Draft 9 for the Research Concepts View (CWE-1000). This term has been obsolete since CWE 1.0, but it might be referenced in older materials.

Source: <https://cwe.mitre.org/documents/glossary/#Natural%20Hierarchy>
...
Source: <https://cwe.mitre.org/documents/glossary/#Neutralization>
...
Source: <https://cwe.mitre.org/documents/glossary/#Neutralize>

---

## Node

an obsolete term for a CWE entry, especially used before CWE 1.0.

Source: <https://cwe.mitre.org/documents/glossary/#Node>
...
Source: <https://cwe.mitre.org/documents/glossary/#Path%20Transversal>
...
Source: <https://cwe.mitre.org/documents/glossary/#Permissions>
...
Source: <https://cwe.mitre.org/documents/glossary/#Pillar%20Weakness>
...
Source: <https://cwe.mitre.org/documents/glossary/#Plaintext>

---

## Platform Resource

a resource that is provided by a platform, e.g., messaging, stream, lock, file, directory, etc. (adapted from CISQ).

Source: <https://cwe.mitre.org/documents/glossary/#Platform%20Resource>
...
Source: <https://cwe.mitre.org/documents/glossary/#Primary%20Weakness>
...
Source: <https://cwe.mitre.org/documents/glossary/#Property>
...
Source: <https://cwe.mitre.org/documents/glossary/#Protection%20Mechanism>

---

## Reliance

a security-relevant assumption that a resource or behavior has a given property, which can lead to weaknesses if that property cannot be guaranteed. For example, an access control protection mechanism might use reverse DNS lookups (CWE-247) in an attempt to limit access to systems in a particular domain; however, this reliance on DNS introduces a weakness because DNS results can be spoofed.

Source: <https://cwe.mitre.org/documents/glossary/#Reliance>

---

## Resolution

the process of converting a resource identifier to a single, possibly canonical form. For example, code that converts "/tmp/abc/../def.xyz" to "/tmp/def.xyz" is performing resolution on an identifier that is being used for a file resource.

Source: <https://cwe.mitre.org/documents/glossary/#Resolution>
...
Source: <https://cwe.mitre.org/documents/glossary/#Resolve>
...
Source: <https://cwe.mitre.org/documents/glossary/#Resource>

---

## Resultant Weakness

a weakness that is only exposed to attack after another weakness has been exploited; a later link in a chain.

Source: <https://cwe.mitre.org/documents/glossary/#Resultant%20Weakness>
...
Source: <https://cwe.mitre.org/documents/glossary/#SDLC>

---

## Sanitization

Use of this term is discouraged in names and descriptions for CWE weaknesses. It has too many different meanings in the industry and may cause mapping errors. It is not precise enough for CWE's purpose. Similar terms in use in CWE may include "Neutralization," "Validation," "Encoding," and "Filtering."

Source: <https://cwe.mitre.org/documents/glossary/#Sanitization>

---

## Sanitize

This term is discouraged for use in CWE. See "Sanitization."

Source: <https://cwe.mitre.org/documents/glossary/#Sanitize>
...
Source: <https://cwe.mitre.org/documents/glossary/#Security%20Policy>

---

## Sensitive Information

Restricted information that should only be accessed by authorized actors. Depending on the context and intended security policy, sensitive information may include secrets such as session identifiers, passwords, access tokens, or cryptographic keys; Personally Identifiable Information (PII) such as email addresses or phone numbers; records or logs of private activities; communications that are expected to be private; etc.

Source: <https://cwe.mitre.org/documents/glossary/#Sensitive%20Information>
...
Source: <https://cwe.mitre.org/documents/glossary/#Slice>
...
Source: <https://cwe.mitre.org/documents/glossary/#Special%20Element>
...
Source: <https://cwe.mitre.org/documents/glossary/#Sphere%20of%20Control>
...
Source: <https://cwe.mitre.org/documents/glossary/#Technology>
...
Source: <https://cwe.mitre.org/documents/glossary/#Technology-Specific>
...
Source: <https://cwe.mitre.org/documents/glossary/#Trailing>
...
Source: <https://cwe.mitre.org/documents/glossary/#Trigger%20Point>
...
Source: <https://cwe.mitre.org/documents/glossary/#Unexpected>
...
Source: <https://cwe.mitre.org/documents/glossary/#Variant%20Weakness>
...
Source: <https://cwe.mitre.org/documents/glossary/#View>
...
Source: <https://cwe.mitre.org/documents/glossary/#Vulnerability>

---

## Vulnerability Theory

a theoretical framework that characterizes aspects of vulnerabilities that are important for describing weaknesses and/or distinguishing from them. Created by CWE staff in 2007, this framework strongly influences the names and descriptions for CWE entries.

Source: <https://cwe.mitre.org/documents/glossary/#Vulnerability%20Theory>
...
Source: <https://cwe.mitre.org/documents/glossary/#Weakness>
