...
| This bill:                                                                              |  |
| <<br>defines terms;                                                                     |  |
| <<br>provides consumers the right to:                                                   |  |
| C<br>access and delete certain personal data maintained by certain businesses; and      |  |
| C<br>opt out of the collection and use of personal data for certain purposes;           |  |
| <<br>requires certain businesses that control and process consumers' personal data to:  |  |
| C<br>safeguard consumers' personal data;                                                |  |
| C<br>provide clear information to consumers regarding<br>how the consumers' personal    |  |
| data are used; and                                                                      |  |
| C<br>accept and comply with a consumer's request to exercise the consumer's rights      |  |
| under this bill;                                                                        |  |
| <<br>creates a right for a consumer to know what personal data a business collects, how |  |
| the business uses the personal data, and whether the business sells the personal data;  |  |
| <<br>upon request and subject to exceptions, requires a business to delete a consumer's |  |
| personal data or stop selling the consumer's personal data;                             |  |
| <<br>allows the Division of Consumer Protection to accept and investigate consumer      |  |
| complaints regarding the processing of personal data;                                   |  |
| <<br>authorizes the Office of the Attorney General to take enforcement action and       |  |
...
| (b) Chapter 10a, Music Licensing<br>Practices Act;                                  |
...
| (o) Chapter 41, Price Controls During<br>Emergencies Act;                           |
| (p) Chapter 42, Uniform Debt-Management Services Act;                               |
| (q) Chapter 49, Immigration Consultants Registration Act;                           |
| (r) Chapter 51, Transportation Network Company<br>Registration Act;                 |
...
<span id="page-2-0"></span>Section 2. Section **13-61-101** is enacted to read:

{3}------------------------------------------------

| S.B. 227 | Enrolled Copy |
|----------|---------------|
|----------|---------------|
...
| 90  | (1) "Account"<br>means the Consumer Privacy Restricted Account established in Section             |
| 91  | 13-61-403.                                                                                        |
| 92  | (2) "Affiliate"<br>means an entity that:                                                          |
...
| 103 | (6) (a) "Biometric data"<br>means data generated by automatic measurements of an                  |
...
| 123 | (b) "Consumer"<br>does not include an individual acting in an employment or commercial       |
| 124 | context.                                                                                     |
...
| 134 | (13) "Covered entity"<br>means the same as that term is defined in 45 C.F.R. Sec.            |
| 135 | 160.103.                                                                                     |
...
| 138 | and                                                                                          |
| 139 | (b) are possessed by<br>a controller who:                                                    |
...
| 154 | (21) "Institution of higher education"<br>means a public or private institution of higher       |
| 155 | education.                                                                                      |
...
| 165 | (25) "Process"<br>means an operation or set of operations performed on personal data,           |
...
| 170 | Sec. 160.103.                                                                                        |
|-----|------------------------------------------------------------------------------------------------------|
| 171 | (28) "Pseudonymous data"<br>means personal data that cannot be attributed to a specific              |
...
| 177 | (a) lawfully<br>obtains from a record of a governmental entity;                                      |
...
| 214 | purpose of identifying<br>a specific individual; or                                           |
...
| 229 | systems or equipment for use by<br>a utility.                                                |
...
| 248 | (36) "Trade secret" means information, including<br>a formula, pattern, compilation,         |
| 249 | program, device, method, technique, or process, that:                                        |
| 250 | (a) derives independent economic value, actual or potential, from not being<br>generally     |
...
| 268 | (a) a governmental entity<br>or a third party under contract with a governmental entity   |
...
| 292 | Quality<br>Improvement Act of 1986, 42 U.S.C. Sec. 11101 et seq., and related regulations; |
...
| 301 | (i) a health care facility<br>or health care provider; or                                  |
...
| 313 | any<br>personal data bearing on a consumer's:                                                      |
...
| 326 | (m) personal data regulated by the federal Family<br>Education Rights and Privacy Act,             |
...
| 343 | the Children's Online Privacy<br>Protection Act, 15 U.S.C. Sec. 6501 et seq., and the act's      |
...
| 346 | Health Insurance Portability<br>and Accountability Act of 1996, 42 U.S.C. Sec. 1320d et seq., or |
...
|-----|-----------------------------------------------------------------------------------------------|
| 367 | (b) to the extent practicable, is readily<br>usable; and                                      |
...
| 378 | (1) A consumer may exercise a right by submitting<br>a request to a controller, by means      |
...
| 390 | (2) (a) Within 45 days after the day<br>on which a controller receives a request to exercise  |
...
|-----|----------------------------------------------------------------------------------------------------|
| 395 | reasonably necessary due to the complexity<br>of the request or the volume of the requests         |
...
| 401 | Subsection (2)(b).                                                                                 |
| 402 | (d) The 45-day period does not apply<br>if the controller reasonably suspects the                  |
...
| 431 | (b) taking<br>into account the nature of the processing and information available to the           |
...
| 441 | (b) requires the processor to ensure each person processing<br>personal data is subject to a       |
...
| 452 | 13-61-302. Responsibilities of<br>controllers Transparency Purpose specification                   |
...
| 464 | engages in targeted advertising, the controller shall clearly<br>and conspicuously disclose to the |
...
| 471 | (ii) reduce reasonably foreseeable risks of harm to consumers relating<br>to the processing        |
...
| 485 | (ii) charging<br>the consumer a different price or rate for a good or service; or                      |
...
| 488 | rate, level, quality, or selection of a good or service to a consumer, including offering<br>a good or |
...
| 523 | pseudonymous data if a controller demonstrates that any information necessary<br>to identify a |
...
| 581 | providing personal data concerning<br>a consumer to a person covered by an evidentiary privilege |
...
| 585 | (a) the controller or processor discloses personal data to a third party<br>controller or        |
...
| 605 | controller or processor violated or is violating<br>this chapter.                                   |
...
| 613 | (1) The attorney general has the exclusive authority<br>to enforce this chapter.                    |
| 614 | (2) Upon referral from the division, the attorney general may initiate an enforcement               |
|     |                                                                                                     |

<span id="page-21-2"></span>action against a controller or processor for a violation of this chapter.
...
| 628 | (c) The attorney<br>general may initiate an action against a controller or processor who:           |
...
| 649 | (b) recovery of costs and attorney fees accrued by<br>the attorney general in enforcing this         |
| 650 | chapter; and                                                                                         |
...
| 654 | (4) If the balance in the account exceeds \$4,000,000 at the close of any<br>fiscal year, the        |
